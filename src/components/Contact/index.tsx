          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center">
              <Button
                ...
                className={`h-12 md:h-12 lg:h-14 w-48 md:w-56 lg:w-64 rounded-full bg-[#2B5D8E] text-base md:text-lg font-medium text-white hover:bg-main-blue ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
