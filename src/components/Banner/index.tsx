...
const Banner = () => {
  ...
  // Biến đổi vị trí dựa trên scrollY
      ...
      <div className="mx-auto h-full flex flex-col md:flex-row items-center justify-between pb-[130px] pr-[54px] pl-[160px] relative">
        ...
        >
          <div className="flex flex-col gap-10">
            <h1 className={`text-4xl md:text-5xl lg:text-[66px] ${notoSansJP.className} select-none font-bold leading-tight text-start -pl-10`} style={{ letterSpacing: "3%" }}>
              「すべての人」に
            </h1>
            <h1 className={`
              pl-10
              text-4xl md:text-5xl lg:text-[66px] ${notoSansJP.className} select-none font-bold leading-tight text-start`} style={{ letterSpacing: "3%" }}>
              ソフトウェア事業を。
            </h1>
          </div>
          <p className={`text-key-visual-copy text-2xl md:text-[56px] select-none ${allison.className} transform -rotate-[8deg] pl-12`} style={{ letterSpacing: "3%" }}>
            Software Business
            <br />
            for Everyone
          </p>
